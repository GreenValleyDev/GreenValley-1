...
Tunnel.bindInterface("Ca_VendeDrogas",emP)
-----------------------------------------------------------------------------------------------------------------------------------------
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookdrugs = ""
...
function emP.checkItens()
	...
	if user_id then 
        return vRP.getInventoryItemAmount(user_id,"maconha") >= quantidade[source] or  vRP.getInventoryItemAmount(user_id,"cocaina") >= quantidade[source]  or  vRP.getInventoryItemAmount(user_id,"lsd") >= quantidade[source]  or  vRP.getInventoryItemAmount(user_id,"metanfetamina") >= quantidade[source] 
	end
end
...
function emP.checkPayment()
	...
	if user_id then
		if vRP.tryGetInventoryItem(user_id,"maconha",quantidade[source]) then
			vRP.giveInventoryItem(user_id,"dinheiro-sujo", (parseInt(2500) + bonus) * quantidade[source])
		end
