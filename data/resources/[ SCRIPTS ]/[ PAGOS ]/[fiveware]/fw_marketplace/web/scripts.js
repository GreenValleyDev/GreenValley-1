...
window.addEventListener('message', function(event) {
	...
	switch (event.data.action) {
		...
		case 'closeMenu':
			$("body").fadeOut();
			$.post('https://fw_marketplace/action', JSON.stringify({
				action: "close",
			}));
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="nui://fw_inventory/nui/images/${img}.png" class="image">
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="nui://fw_inventory/nui/images/${itemsAds[i].item_id}.png" class="image">
								<div class="item_card-spacer" style="margin-bottom: -50;">
					...
					<div class="col-md-3">
						<div class="card item_card d-flex flex-column">
							<div class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between pb-1 align-items-center">
								...
								<img src="nui://fw_inventory/nui/images/${blackmarketAds[i].item_id}.png" class="image">
								<div class="item_card-spacer" style="margin-bottom: -50;">
