...
local barberShops = {
    [1] = { coords = vec3(-281.05,6227.46,31.73) },
    [2] = { coords = vec3(-556.84,-585.44, 41.44) },
}
...
local barberChairs = {
    ...
    [2] = {
        { coords = vec3(-556.92, -587.41, 41.44), h = 92.25, offset = vec3(-0.04, -0.68, 0.0) },   
        { coords = vec3(-556.84, -585.44, 41.44), h = 88.83, offset = vec3(-0.04, -0.68, 0.0) },   
        { coords = vec3(-556.88, -583.46, 41.44), h = 91.25, offset = vec3(-0.04, -0.68, 0.0) },   
        { coords = vec3(-556.86, -581.44, 41.44), h = 92.25, offset = vec3(-0.04, -0.68, 0.0) },   
    }
}
...
RegisterCommand("barbearia", function() -- abrir menu do barbershop (admin)
    if func.checkPermission({"barbershop.permissao",}) then
