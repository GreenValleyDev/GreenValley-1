...
skinshops = {
    ...
    [15] = {
        clothes = getClothes, permission = nil, coords = vec3(393.55, 278.85, 95.0)   --- ['x'] = 1150.22, ['y'] = -162.31, ['z'] = 57.85
    },

   -- [16] = {
     --   clothes = getClothes, permission = nil, coords = vec3(-851.57,-1806.64,31.29)   
   -- },

    [17] = {
        clothes = getClothes, permission = nil, coords = vec3(1150.22,-162.31,57.85)   
    },
    [18] = {
        clothes = getClothes, permission = nil, coords = vec3(233.6,767.41,188.94)   
    },
    [19] = {
        clothes = getClothes, permission = nil, coords = vec3(-566.59, -582.97, 34.69), blip = false  --SHOP
    },
    [20] = {
        clothes = getClothes, permission = nil, coords = vec3(-564.33, -583.0, 34.69), blip = false  --SHOP
    },
    [21] = {
        clothes = getClothes, permission = nil, coords = vec3(-529.74, -604.51, 41.44), blip = false  --SHOP
    },
    [22] = {
        clothes = getClothes, permission = nil, coords = vec3(-530.24, -609.73, 41.44), blip = false  --SHOP
    },
...
RegisterCommand('roupas',function() -- COMANDO DE ADMIN
    if func.checkPermission({"skinshop.permissao",}) then
        toggleMenu("manager")
    end
end)
