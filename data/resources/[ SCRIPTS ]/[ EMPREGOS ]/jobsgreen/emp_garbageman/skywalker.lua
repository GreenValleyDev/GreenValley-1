...
function emp1.payment()
    ...
    if user_id then
		...
		vRP.giveInventoryItem(user_id,"plastico",math.random(4,6))
		vRP.giveInventoryItem(user_id,"elastico",math.random(4,6))
		vRP.giveInventoryItem(user_id,"papel",math.random(4,6))
