...
function vRPN.checkPlayer2()
	...
	if nplayer then
		if vRP.hasPermission(user_id,"manager.permissao") or vRP.hasPermission(user_id,"administrador.permissao") or vRP.hasPermission(user_id,"moderador.permissao") or vRP.hasPermission(user_id,"suporte.permissao") or vRP.hasPermission(user_id,"ems.permissao") or vRP.hasPermission(user_id,"policia.permissao") then
			return true
		end
	else
...
function vRPN.nuIdentidade2()
	...
	if nplayer then
		...
		if identitynu then
			return identitynu.foto,identitynu.name,identitynu.firstname,identitynu.registration,nuser_id,identitynu.age,cnh,identitynu.phone
		end
	end
end
