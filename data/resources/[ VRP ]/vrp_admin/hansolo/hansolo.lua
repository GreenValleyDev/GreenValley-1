...
RegisterNetEvent('spawnarveiculo17')
AddEventHandler('spawnarveiculo17',function(name)
...
--         TriggerEvent("Notify","sucesso","Godmode <b>desativado</b>")
--     elseif not active then
--         SetEntityInvincible(ped, true)
--         TriggerEvent("Notify","sucesso","Godmode <b>ativado</b>")
--     end
--     active = not active
-- end)
...
RegisterNetEvent("cds5")
AddEventHandler("cds5",function(x,y,z)
    local x,y,z = table.unpack(GetEntityCoords(PlayerPedId(),true))
	local h = GetEntityHeading(PlayerPedId())
	vRP.prompt("Cordenadas:","['x2'] = "..tD(x)..", ['y2'] = "..tD(y)..", ['z2'] = "..tD(z-1.0)..", ['h'] = "..tD(h))
end)

RegisterNetEvent("cds6")
AddEventHandler("cds6",function(x,y,z)
    local x,y,z = table.unpack(GetEntityCoords(PlayerPedId(),true))
	local h = GetEntityHeading(PlayerPedId())
	vRP.prompt("Cordenadas:",""..tD(x)..", "..tD(y)..", "..tD(z-1.0)..", "..tD(h))
end)
