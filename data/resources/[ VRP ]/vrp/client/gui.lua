...
RegisterKeyMapping ( 'vrp:apontar' , '[B] Apontar os dedos' , 'keyboard' , 'B' )

RegisterCommand('vrp:apontar', function()
	local ped = PlayerPedId()
	if not IsPedInAnyVehicle(ped) and not menu_celular and GetEntityHealth(ped) > 101 and not cancelando then
