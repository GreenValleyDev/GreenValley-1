...
Citizen.CreateThread(function()
	local function playerConnect(name,setKickReason,deferrals)
		...
		if Config.RequireSteam and not Queue:IsSteamRunning(src) then -- if Config.RequireSteam and not Queue:IsSteamRunning(src) then
