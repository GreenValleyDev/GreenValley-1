...
function vRP.setHunger(user_id,value)
  ...
  if data then
    ...
    local hunger = (100 - data.hunger ) / 100
    TriggerClientEvent("nation_hud:setHunger", source, hunger)
    local thirst = (100 - data.thirst ) / 100
    TriggerClientEvent("nation_hud:setThirst", source, thirst)
