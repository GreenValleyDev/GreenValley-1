...
vRP.prepare("vRP/update_user_slots","UPDATE vrp_user_identities SET slots = slots + @slots WHERE user_id = @user_id")
vRP.prepare("vRP/set_user_slots","UPDATE vrp_user_identities SET slots = @slots WHERE user_id = @user_id")
