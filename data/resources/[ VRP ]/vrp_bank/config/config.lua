...
config.logBankFines = "https://discord.com/api/webhooks/917540720238276608/sA3AYFPGmqSBrU5d8MkbMSI7r59iSjYjFBO6jGsAbQidP3S0oEb-YzVIgdgZs8OY5gvV" -- Registro de weebhook pagar pelo comando ( /multas pagar )
config.logBankFines1 = "https://discord.com/api/webhooks/917540720238276608/sA3AYFPGmqSBrU5d8MkbMSI7r59iSjYjFBO6jGsAbQidP3S0oEb-YzVIgdgZs8OY5gvV" -- Registro de weebhook de multas paga pelo banco
config.logBankSacar = "https://discord.com/api/webhooks/917540550025031700/QlXonCzQLF8n_GUZ19jnMOP7JlJtcMmwwmBgMKyGqZx-dcDGj90XhNGVCjX2wnWJwuYq"
config.logBankDepositar = "https://discord.com/api/webhooks/917540847434743808/ANwDRfSgN4qvsVictWBfKcB4EcaXZ_1LE-O0L3ZwNlTYRxWyTB42X5-l5pQPEaEIjJsl"
config.logBankTransferencia = "https://discord.com/api/webhooks/917540922978336818/enaGNDDUDBLK9RXZ_QGhVu3Ty_rlUMtDydL16uw-Fl6r9FxBq0QDPLPEcuVBDRFSTg4z"
config.webhookRCaixaEletronico = "https://discord.com/api/webhooks/917541055468023909/ZlksaMT3PoSNmgEZnQbg-HY25EvA3cnkA9JCHL-fr5bw-nSJagtchTfbuo3FtjBfqjd-"
...
config.banks = {
	...
	{name='Bank', id=108, x=1160.76, y=-152.86, z=57.8}, -- 1160.76, ['y'] = -152.86, ['z'] = 57.8
	...
	{name='Bank', id=108, x=-350.98, y=-49.89, z=49.05}, -- 937.0, 26.25, 71.84
	{name='Bank', id=108, x=937.0, y=26.25, z=71.84},
...
config.atms = {
	...
	{name='ATM', id=277, x=817.21, y=-929.29, z=32.4},
}