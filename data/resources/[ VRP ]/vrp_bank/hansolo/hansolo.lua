			...
			if nearbank() then
				...
				if IsControlJustPressed(1, 38) then
					...
					-- if parseInt(hora) >= 07 and parseInt(hora) <= 21 then
						...
						TriggerServerEvent('bank:balance20')
...
RegisterNUICallback('depositar', function(data)
	if nearbank() then
		TriggerServerEvent('bank:depositar20', tonumber(data.amount))
		TriggerServerEvent('bank:balance20')
	else
...
RegisterNUICallback('sacar', function(data)
	TriggerServerEvent('bank:sacar20', tonumber(data.amounts))
	TriggerServerEvent('bank:balance20')
	TriggerEvent('balance')
end)

RegisterNUICallback('pagar', function(data)
	TriggerServerEvent('bank:pagar20', tonumber(data.amountp))
	TriggerServerEvent('bank:balance20')
end)
...
RegisterNUICallback('transferir', function(data)
	TriggerServerEvent('bank:transferir20', data.to, data.amountt)
	TriggerServerEvent('bank:balance20')
end)

RegisterNetEvent('bank:result20')
AddEventHandler('bank:result20', function(type, message)
